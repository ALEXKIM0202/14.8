...
<body style="display: flex;justify-content: end; background-image:url(../img/drew-dizzy-graham-cTKGZJTMJQU-unsplash.jpg);background-size:50%;background-repeat:no-repeat;background-attachment:fixed;background-position:left;">
	...
	<div style="border: 1px solid black;display: flex;flex-direction: column;width:30%;top: 50%;margin:20%; ">
		...
		if (null !== getCurrentUser()) { ?>
			...
			<div class="sale">
				<h3>Акция! спа с массажем, пилингом и чаетитием - 50%</h3>
